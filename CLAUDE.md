...
- [`docs/ALLSKY_HOSTING_SITE_PLAN.md`](docs/ALLSKY_HOSTING_SITE_PLAN.md) — issue #93: persisted equipment map, observable-sky gate (roof verdict + star evidence), chance-aware quality, pole from the rotating field with Polaris hidden, pole-constrained solve; five independently mergeable packages with agent briefs
